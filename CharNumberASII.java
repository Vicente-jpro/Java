 ...
 * @author vicente-jpro
 * 
 * This class contains constructor CharNumberASII(String validateNumber)
 * that resive a number to validate.
 * 
 */
    ...
    public String getStringNumber() throws NumberFormatException{
       ...
       while(beguin < end){
           ...
           if ( validateNumber.codePointAt( beguin ) >= 48 && validateNumber.codePointAt( beguin ) <= 57 )
               ...
               break; // Break the loop because it found a diferente simbol
